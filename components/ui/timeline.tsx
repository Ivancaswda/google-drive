    ...
    >
      <div className="mx-auto max-w-7xl px-4 py-20 md:px-8 lg:px-10">
        <h2 className="mb-4 max-w-4xl text-lg text-black dark:text-white md:text-4xl">
         Мой путь как Fullstack Developer
        </h2>
        <p className="max-w-sm text-sm text-neutral-700 dark:text-neutral-300 md:text-base">
        Я начал свой путь еще в сентябре 2023 года и уверенно двигался по ступеням девелопера преодолевая множество трудностей и преград в конечном итоге добиваясь успеха
        </p>
      </div>
      ...
      <div ref={ref} className="relative mx-auto max-w-7xl pb-20">
        ...
        >
          <motion.div
            ...
            className="via-blue-500 absolute inset-x-0  top-0 w-[2px] rounded-full bg-gradient-to-t from-purple-500 from-0% via-10% to-transparent"
          />
        </div>
      </div>
    </div>
